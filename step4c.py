...
for i, line in enumerate(lines):
    if "Teams Joined" in line:
        idx = i
        break

print("found Teams Joined at line:", idx+1 if idx is not None else None)

if idx is not None:
    insert_at = idx - 2
    print("inserting before line:", insert_at+1, repr(lines[insert_at]))
