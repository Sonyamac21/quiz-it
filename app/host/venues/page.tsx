  ...
  return (
    <div style={{ minHeight: "100vh", background: "linear-gradient(160deg, #1a0535 0%, #0d0225 100%)", color: "#fff", padding: "32px 48px", fontFamily: "sans-serif" }}>
      <div style={{ display: "flex", alignItems: "center", gap: 12, marginBottom: 28 }}>
        ...
        <div style={{ flex: 1 }} />
        <a href="/host/session" style={{ padding: "10px 20px", borderRadius: 8, border: "1px solid rgba(190,38,193,0.6)", color: "#BE26C1", textDecoration: "none", fontSize: 14 }}>Back to Session</a>
      </div>
      ...
      <div style={{ display: "flex", flexDirection: "column", gap: 12, maxWidth: 700 }}>
        {DAYS.map((dayName, i) => {
          ...
          return (
            <div key={i} style={{ display: "flex", alignItems: "center", gap: 16, padding: "16px 20px", borderRadius: 12, background: "rgba(45,10,94,0.5)", border: "1px solid rgba(190,38,193,0.3)" }}>
              ...
              <label style={{ padding: "6px 12px", borderRadius: 8, background: "rgba(190,38,193,0.15)", border: "1px solid rgba(190,38,193,0.4)", color: "#BE26C1", fontSize: 12, cursor: "pointer", flexShrink: 0 }}>
                {uploadingDay === i ? "..." : "Logo"}
              ...
              <input
                ...
                style={{ flex: 1, padding: "10px 14px", borderRadius: 8, background: "rgba(255,255,255,0.08)", color: "#fff", border: "1px solid rgba(190,38,193,0.3)", fontSize: 14 }}
              />

              <button onClick={() => saveDay(i)} disabled={savingDay === i} style={{ padding: "8px 16px", borderRadius: 8, background: "rgba(190,38,193,0.3)", border: "1px solid #BE26C1", color: "#fff", fontSize: 12, cursor: "pointer", flexShrink: 0 }}>
