...
export default function QuestionsPage() {
  ...
  async function generate() {
    ...
    const seed = Math.floor(Math.random() * 999999); const topicBanks = ["history,science,geography","food,music,sport","movies,TV,pop culture","animals,nature,space","literature,art,fashion","technology,business,politics","mythology,religion,philosophy","transport,architecture,inventions"]; const randomTopics = topicBanks[Math.floor(Math.random() * topicBanks.length)]; const themeNote = theme ? "Topic: " + theme + "." : "Mix of fun general knowledge topics. Seed:" + seed + ". Focus on these topic areas this time: " + randomTopics + ". Be creative and unexpected - avoid obvious or overused quiz questions.";
