...
//
// Reads speedquizzing_multitap_export.csv (already sitting in this folder),
// sends questions to Claude in batches of 25 to get a topic tag + a
// stale-risk flag, and writes speedquizzing_multitap_reviewed.csv next to
...
const IN_CSV = path.join(__dirname, "speedquizzing_multitap_export.csv");
const OUT_CSV = path.join(__dirname, "speedquizzing_multitap_reviewed.csv");
