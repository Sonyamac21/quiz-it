...
export function SpinToWinPanel({ teamName, victorySong, sessionPin, onClose }: Props) {
  ...
  return (
    <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(5,2,10,0.97)", zIndex: 200, display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <SlotMachine initialTeamName={teamName} initialVictorySong={victorySong || undefined} sessionPin={sessionPin || undefined} />
