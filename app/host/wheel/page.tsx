  ...
  return (
    <div style={{ minHeight:"100vh", background:"#080810", color:"#fff", display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", padding:"24px 16px" }}>
        <div style={{ marginBottom:24, width:"100%", maxWidth:520 }}>
          <label style={{ fontSize:11, color:"rgba(190,38,193,0.6)", display:"block", marginBottom:8, letterSpacing:2, fontFamily:"'Bruno Ace SC', sans-serif" }}>Which team is spinning?</label>
          <input
            value={team}
