    ...
    <div style={{ minHeight:"100vh", background:"#080810", color:"#fff", display:"flex", flexDirection:"column" }}>
      ...
      <div style={{ flex:1, display:"flex", flexDirection:"column", alignItems:"center", padding:"24px 16px" }}>
        <div style={{ marginBottom:20, width:"100%", maxWidth:520, display:"flex", gap:12 }}>
          <div style={{ flex:1 }}>
            <label style={{ fontFamily:"'Inter',sans-serif", fontSize:10, letterSpacing:3, color:"rgba(190,38,193,0.6)", display:"block", marginBottom:6 }}>Team Name</label>
            <input value={team} onChange={e => setTeam(e.target.value)} placeholder="Enter team name..." style={{ padding:"10px 16px", borderRadius:10, background:"#0f0f1a", color:"#fff", border:"1px solid rgba(190,38,193,0.4)", fontSize:15, width:"100%", outline:"none", fontFamily:"'Inter',sans-serif" }} />
          </div>
          <div style={{ flex:1 }}>
            <label style={{ fontFamily:"'Inter',sans-serif", fontSize:10, letterSpacing:3, color:"rgba(190,38,193,0.6)", display:"block", marginBottom:6 }}>Victory Song</label>
            <input value={victorySong} onChange={e => setVictorySong(e.target.value)} placeholder="Song filename..." style={{ padding:"10px 16px", borderRadius:10, background:"#0f0f1a", color:"#fff", border:"1px solid rgba(190,38,193,0.4)", fontSize:15, width:"100%", outline:"none", fontFamily:"'Inter',sans-serif" }} />
          </div>
        </div>
